...
configurable_parameters = [{'name': 'camera_name',                  'default': 'kinect_camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'base_frame_id',                'default': 'kinect_camera', 'description': 'Root frame of the sensors transform tree'},
                          ]
