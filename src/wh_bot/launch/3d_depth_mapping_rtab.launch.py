...
def generate_launch_description():
    ...
    parameters = {
        ...
        # Input configuration
        'subscribe_depth': False,           # no /depth/image_raw
        'subscribe_scan_cloud': True,       # using point cloud from Kinect
        'subscribe_rgb': True,              # enable RGB camera
        ...
        'qos_image': qos,
        'qos_imu': qos,
        'Reg/Force3DoF': 'true',            # planar mapping
    ...
    remappings = [
        ...
        # Kinect pointcloud as depth substitute
